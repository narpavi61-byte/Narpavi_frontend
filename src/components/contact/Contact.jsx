  ...
  return (
    <div className="w-full">
      ...
      <div className="relative -mt-24 md:-mt-28 px-4 z-20 mb-20">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-gray-300 shadow-xs p-8 md:p-12">
          ...
          <div className="space-y-6">
            ...
            <div className="">
              ...
              <div className="mt-5 flex flex-col w-full  md:flex-row gap-6 justify-center items-center">
                <div className="flex items-center  border border-gray-300 gap-4  rounded-lg px-6 py-4 w-1/2 ">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-700">infooo@narpaviproperties.com</p>
                  </div>
                </div>
